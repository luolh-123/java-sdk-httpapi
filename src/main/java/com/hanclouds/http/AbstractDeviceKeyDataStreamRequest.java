 ...
 */
public abstract class AbstractDeviceKeyDataStreamRequest<T extends AbstractHttpResponse> extends AbstractDeviceKeyRequest<T> {

    protected String dataName;

    public AbstractDeviceKeyDataStreamRequest(String url) {
        super(url);
    }
